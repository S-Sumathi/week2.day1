...
public class DuplicateLead {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("createLeadForm_companyName")).sendKeys("TestLeaf4");
		driver.findElement(By.id("createLeadForm_firstName")).sendKeys("test4");
		driver.findElement(By.id("createLeadForm_lastName")).sendKeys("leaf4");
